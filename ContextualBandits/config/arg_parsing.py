...
def get_argument() -> Namespace:
    ...
    parser.add_argument("--project", type=str, default="ContextualBandits")
    ...
    parser.add_argument("--trainer.plot_freq", type=int)

    # evaluator
    parser.add_argument("--evaluator.name", type=str)
    parser.add_argument("--evaluator.num_exp", type=int)
    parser.add_argument("--evaluator.learn_ratio", type=float)
    parser.add_argument("--evaluator.plot_comparison_shape", type=str)
    parser.add_argument("--evaluator.plot_freq", type=int)

    # model
    parser.add_argument("--model.name", type=str, choices=["mlp", "np", "anp", "bnp", "banp",])
    parser.add_argument("--model.size", type=str, choices=["base", "large",])

    # data_sampler
    parser.add_argument("--data_sampler.num_contexts", type=int)
    parser.add_argument("--data_sampler.dim_context", type=int)

    # dataset
    parser.add_argument("--dataset.train.day", nargs="+", type=int)
    parser.add_argument("--dataset.val.day", nargs="+", type=int)
    parser.add_argument("--dataset.reward_balance", type=float,
    ...
    parser.add_argument("--dataloader.num_workers", type=int)
